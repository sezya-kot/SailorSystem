...
import com.sezyakot.android.sailorapp.sailor.model.DataLogin;
import com.sezyakot.android.sailorapp.sailor.model.User;
...
public class Net {
    ...
    private static void generateUserErrorCode() {
        user = new User();
        user.setError(new com.sezyakot.android.sailorapp.sailor.model.Error());
